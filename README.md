...
** Run the backend url - https://spur-backend2.onrender.com/ and wait for 30 seconds then run then frontend url - https://spur-frontend-eene.onrender.com/ and wait for 30 seconds.
